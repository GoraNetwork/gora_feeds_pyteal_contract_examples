...
from demo_configs.request_specs import sportsFeedSourceOneTeamScore,sportsFeedSourceEntireMatchInfo
...
try:
    result = requestContract.call(
        ...
        aggregation_number = 1, # FOR A SINGLE VALUE LIKE A NUMBER IT IS REQUIRED U USE AN AGGREGATION NUMBER OF 1 INSTEAD OF 0
        user_data=user_data,
        box_references=[],
        app_references=[],
        asset_references=[],
